...
class TestExportExtra(unittest.TestCase):
    ...
    def test_csv_export_returns_generator_and_streams_correctly(self):
        ...
        self.assertIn(
            "id;name;phone;email;source;preferred_channel;reminder_consent;vehicles_count;orders_count;notes",
            full_content,
        )
    ...
    def test_csv_export_orders_streams_totals_and_items(self):
        ...
        self.assertIn(
            "id;number;status;customer_name;vehicle_plate;vehicle_make;vehicle_model;authorized_by;authorized_at;follow_up_at;total;paid;due;created_at;updated_at",
            full_content,
        )
