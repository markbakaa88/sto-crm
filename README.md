...
Release-only репозиторий должен быть публичным: приложение не использует GitHub-токены и не хранит авторизацию для скачивания обновлений.
...
- премиальный профессиональный рабочий интерфейс: executive hero-панель, операционный статус-бар смены, nav-бейджи рисков, единые заголовки разделов, темная/светлая тема, переключатель плотности, командная палитра Ctrl+K, адаптивная навигация, быстрые действия, offline-индикатор и улучшенные пустые состояния;
