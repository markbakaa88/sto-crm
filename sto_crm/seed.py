...
def seed_demo_data() -> None:
    with write_db() as conn:
        ...
        vehicles = [
            (customer_ids[0], "Toyota", "Camry", 2018, "A123AA", "JTNB11HK303000001", 82000, 82000, next_service_date, 90000, ""),
            (customer_ids[1], "Hyundai", "Solaris", 2021, "T451TX", "Z94K241CBMR000002", 146000, 146000, "", 150000, "Такси"),
            (customer_ids[2], "Kia", "Sportage", 2020, "M777MA", "XWEPH81BDL0000003", 61000, 61000, "", 0, ""),
        ]
