"""Shared helper utilities for parts supplier API validation and normalization."""
...
def sanitize_part_search_result(
    ...
    """Validate that price, quantity, delivery times, and other fields are finite,

    non-negative, and fit within SQLite integer/float bounds. Invalid items
    are handled gracefully returning None.
    """
